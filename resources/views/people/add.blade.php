    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Person Add Form</h3>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => 'people', 'method' => 'POST', 'class' => 'form-horizontal', 'id'=>"addPersonForm" ]) !!}
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group @if($errors->has('birth_date')) has-danger @endif">
                                        ...
                                        {!! Form::text('birth_date',NULL,['class' => 'form-control mydatepicker','id' => 'birth_date','placeholder' => 'mm/dd/yyyy']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @if($errors->has('language_id')) has-danger @endif">
                                        ...
                                        {!! Form::select('language_id',$languages,0,['class' => 'form-control custom-select' ,'id' => 'language_id']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @if($errors->has('interests')) has-danger @endif">
                                        ...
                                        {!! Form::select('interests[]',$interests,0,['class' => 'form-control select2 select2-multiple' ,'id' => 'interests','multiple' => 'multiple']) !!}
